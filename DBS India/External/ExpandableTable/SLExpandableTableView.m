...
//
@class SLExpandableTableViewControllerHeaderCell;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (![self.expandableSectionsDictionary[key] boolValue]) {
        ...
        // cell is expandable
        if (indexPath.row == 0) {
            UITableViewCell<UIExpandingTableViewCell> *cell = [self.myDataSource tableView:self expandingCellForSection:indexPath];
