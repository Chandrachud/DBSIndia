...
@interface AddBudgetStep2Controller ()

@property(nonatomic, strong) AddBudgetStep3Controller *budgetStep3;
- (IBAction)next:(id)sender;
- (IBAction)cancel:(id)sender;
@end

@implementation AddBudgetStep2Controller
...
- (IBAction)next:(id)sender
{
    _budgetStep3 = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"AddBudgetStep3Controller"];
    [self.navigationController pushViewController:_budgetStep3 animated:YES];
}
